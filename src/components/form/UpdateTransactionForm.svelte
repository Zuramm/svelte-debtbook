<script>
	...
	/** @type {{ id: number, personId?: number | null, people: { id: number, name: string }[], direction?: "gave" | "received", amount?: number | null, ocurred_at: Date, description?: string | null, onclose?: () => void }} */
	let {
		id,
		personId = $bindable(),
		people = [],
